...
<div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
  ...
  <h3 style=" text-align:center;"><u style="text-underline-offset: 8px;">टिप्पणी र आदेश</u></h3>
    ...
    <div style="margin-top: 20px;">
      ...
      <p style="font-size: 0.8rem;">&nbsp; &nbsp;&nbsp; &nbsp;  चालु आ.ब. २०८०/८१ को लागि ${upavoktaSamitiKoNaam} बाट स्वीकृत बार्षिक योजना तथा कार्यक्रम अन्तर्गत mukhya samiti तर्फको सि.नं. ३२ मा ${yojanaKaryaKramKoNaam} वडा नं. ८  का लागि budget karyakram रु.${lagatAnumanRakam}   रु.२०००.००  गरि जम्मा रु.३०००.००    विनियोजन भएको छ ।</p>
