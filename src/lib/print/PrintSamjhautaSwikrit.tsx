...
const printContent = async (
  aawa: any,
  miti: any,
  yojanaKaryaKramKoNaam: any,
  upavoktaSamitiKoNaam: any,
  adhyachyaKoNaam: any,
  velamaUpasthitiSankhya: any,
  padakariSankhya: any,
  mahilaSankhya: any,
  lagatAnumanRakam: any,
  nagarpalikaRakamRu: any,
  lagatSramDan: any,
  contengencyRakam: any,
  khudPauneRakam: any,
  anugamanSamitikaSadasya: any,
  budgetKitabSNum: any,
  ushaGathanMiti: any,
  mukhyaSamitiKoNaam: any,
  ushaNibedandiyiyekoMiti: any,
  anyaTipaniBivaran: any,
  yojanakoNaam: any,
  wadaNum: any,
  biniyojitRakamRu: any,
  sanyojak: any,
  sadasyaOne: any,
  sadasyaTwo: any,
  anudanKoNaam: any,
  ...
  budgetKitabSnum: any,
  budgetType: any,
  contengencyResult: any,
  dharautiRakam: any,
  gharPariwarSankhya: any,
  janaSankhya: any,
  karyaBivaran: any,
  karyagatSamuha: any,
  kramagatYojana: any,
  lagatSrotAmount: any,
  lagatSrotAmount2: any,
  lagatSrotAmount3: any,
  lagatSrotHaru: any,
  lagatSrotHaru2: any,
  lagatSrotHaru3: any,
  markmatRakamResult: any,
  marmatRakam: any,
  mukhyaSamiti: any,
  prastabSwikritMiti: any,
  sabhaNirnayaMiti: any,
  thegana: any,
  upalabdhiLakshya: any,
  uplabdhiLakhshyaQty: any,
  wada: any,
  yojanaKoKisim: any,
  yojanaKoWada: any,
  yojanaSwikrit: any,
...
<div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
  ...
  <h3 style=" text-align:center;"><u style="text-underline-offset: 8px;">टिप्पणी र आदेश</u></h3>
    ...
    <div style="margin-top: 20px;">
      ...
      <p style="font-size: 0.8rem;">&nbsp; &nbsp;&nbsp; &nbsp;  चालु आ.ब. ${miti} को लागि yojana chanot nikaya बाट स्वीकृत बार्षिक योजना तथा कार्यक्रम अन्तर्गत ${mukhyaSamitiKoNaam} तर्फको सि.नं. ३२ मा ${yojanaKaryaKramKoNaam} वडा नं. ८  का लागि budget karyakram रु.१०००.००   रु.२०००.००  गरि जम्मा रु.३०००.००    विनियोजन भएको छ ।</p>
