...
const printContent = async (yojanaKoNaam: any) => {
  ...
  const htmlContent = `
    <div style="text-align: center;">
      ...
      <h1>शुद्धोधन गाउँपालिका</h1>
      <h2>गाउँ कार्यपालिकाको कार्यालय</h2>
      <h3>मानपकडी, रुपन्देही</h3>
      <h4>लुम्बिनी प्रदेश नेपाल</h4>
    ...
    <div style="margin-top: 20px;">
      <p>श्रीमान,</p>
      <p>चालु आ.ब. 2080/81 को लागि yojana chanot nikaya बाट स्वीकृत बार्षिक योजना तथा कार्यक्रम अन्तर्गत mukhya samiti तर्फको सि.नं. 32 मा yojana ko naam second वडा नं. 8 का लागि budget karyakram 3 रु.1000.00  रु.2000.00 गरि जम्मा रु.3000.00   विनियोजन भएको छ ।</p>
